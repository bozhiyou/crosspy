...
def get_device(obj, *, reg_by_id: Optional[dict] = None):
    ...
    except NotImplementedError:  # patch for CuPy sparse matrix
        assert hasattr(obj, 'data') and hasattr(obj.data, 'device'), ValueError("Unknown device", type(obj), obj)
        return obj.data.device
